...
* Download "plovr":http://code.google.com/p/plovr
* Run <code>java -jar plovr.jar serve annotator.json</code> in the working directory 
* Open <code>index.html</code> in your browser - and code away
* To build the minified JavaScript, run <code>java -jar plovr.jar build annotator.json > yuma2.min.js</code> (replacing 'yuma2.min.js' with a file name of your choice)

h2. Upcoming Work/Todos

* Clean up namespacing (it's a bit messy after the last refactoring) 
* Real custom mouseover/mouseout events for annotations
* Popup annotation edit form
