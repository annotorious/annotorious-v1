...
annotorious.mediatypes.Module.prototype._initAnnotator = function (item) {
  ...
  if (this._cachedProperties && Object.keys(this._cachedProperties).length !== 0)
...
/**
 * Save the properties in the cache
 * @param {Object} props the properties object
 * @param {Object} cachedProperties variable to save properties
 */
annotorious.mediatypes.Module.prototype._saveProperties = function (props, cachedProperties) {
  var self = this;
  if (props instanceof Object && Object.keys(props).length !== 0) {
    goog.array.forEach(Object.keys(props), function (key) {
      if (props[key] instanceof Object) {
        if (!cachedProperties.hasOwnProperty(key)) cachedProperties[key] = {};
 ...
 */
annotorious.mediatypes.Module.prototype.removeProperties = function () {
  this._cachedProperties = {};
...
annotorious.mediatypes.Module.prototype.setProperties = function (props) {
  if (!(props instanceof Object) || Object.keys(props).length === 0) return;
  this._saveProperties(props, this._cachedProperties);

  if (props.hasOwnProperty("hideSelectionWidget"))
    this._setSelectionWidgetVisibility(undefined, !props['hideSelectionWidget']);
  if (props.hasOwnProperty("hideAnnotations"))
    this._setAnnotationVisibility(undefined, !props['hideAnnotations']);
